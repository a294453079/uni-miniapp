...
export const useGlobalSetting = () => {
  ...
  return {
    ...
    apiUrl: import.meta.env.VITE_APP_NODE_ENV === 'development' ?
      import.meta.env.VITE_APP_DEV_API_URL : import.meta.env.VITE_APP_DEV_API_URL,
    ...
    checkAuth: import.meta.env.VITE_APP_NEED_LOGIN === 'false' ? false : true,
    tmpIds,
